...
the_numbers_urls = [
    "https://www.the-numbers.com/movie/Inception#tab=summary",
    "https://www.the-numbers.com/movie/Avatar#tab=summary",
    "https://www.the-numbers.com/movie/Dark-Knight-The#tab=summary",
    "https://www.the-numbers.com/movie/Interstellar#tab=summary",
]
from src.boxoffice_scraper import fetch_batch
df_bn = fetch_batch(the_numbers_urls)
save_raw_csv(df_bn, path="data_raw/the_numbers_master.csv")
